...
from train_val_test_plot_functions_cv_NU_ResNet import create_weighted_sampler, dataloader_prep_with_sampler, dataloader_prep, train_val_ResNet_expert_color_mat_cv, test_ResNet_expert
...
for k, index_train_val_test_data in enumerate(k_fold_index_train_val_test_data):
    ...
    train_val_record_obtained, saved_models_metrics_obtained = train_val_ResNet_expert_color_mat_cv(device = device_utilized, 
