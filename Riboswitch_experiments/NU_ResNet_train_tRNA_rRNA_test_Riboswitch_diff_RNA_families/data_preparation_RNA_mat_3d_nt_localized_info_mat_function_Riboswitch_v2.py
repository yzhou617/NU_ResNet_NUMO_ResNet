...
def data_prep_RNA_mat_3d_nt_localized_info_mat_riboswitch_data(Original_RNA_Data, padding_length):
    ...
    #color_mat_3d_predicted_RNA_structure = Original_RNA_Data[['color_matrix_seq_exprtss', 'nt_localized_info_matrix_seq_exprtss', 'dist_positive_negative_samples']].copy(deep=True)
    ...
    color_matrix_data_set_combined = color_mat_3d_actual_RNA_structure
    ...
    color_matrix_data_set_combined['RNA_Label'] = 1
