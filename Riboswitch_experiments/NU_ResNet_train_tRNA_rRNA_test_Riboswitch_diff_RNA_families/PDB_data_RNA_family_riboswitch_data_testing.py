...
def RNA_family_riboswitch_data_testing_function(test_data_file, riboswitch_data_set, device_utilized_para, loss_function_utilized_para, testing_data_name_para, NN_test_model_best_acc_para, best_val_acc_model_name_para, NN_test_model_best_loss_para, best_val_loss_model_name_para, NN_test_model_last_epoch_para, model_from_last_epoch_name_para):
