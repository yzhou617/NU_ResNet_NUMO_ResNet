...
import numpy as np
from PDB_data_RNA_family_riboswitch_data_testing import RNA_family_riboswitch_data_testing_function  
...
concat_loss_b_v_a, concat_metric_b_v_a, concat_loss_b_v_l, concat_metric_b_v_l, concat_loss_model_l_e, concat_metric_model_l_e = RNA_family_riboswitch_data_testing_function(test_data_file='concatenated_different_RNA_families_testing_data.csv',
...
'''
concat_2_loss_b_v_a, concat_2_metric_b_v_a, concat_2_loss_b_v_l, concat_2_metric_b_v_l, concat_2_loss_model_l_e, concat_2_metric_model_l_e = RNA_family_riboswitch_data_testing_function(test_data_file='concatenated_different_RNA_families_otherRNA_testing_data.csv',
                                                                                                                                                                                         riboswitch_data_set = Riboswitch_RNA_Data_obtained,
                                                                                                                                                             device_utilized_para=device_utilized,
                                                                                                                                                             loss_function_utilized_para=loss_function_utilized,
