...
# 1. Load the data
Original_RNA_Data_train = pd.read_csv('PDB_data_reliable_negative_samples_testing_data.csv')
...
Original_RNA_Data_train_analysis.to_csv('equilibrium_prob_PDB_data_analysis_20240204.csv', index=False)
