...
from train_val_test_plot_functions_cv_NUMO_ResNet import create_weighted_sampler, dataloader_prep_with_sampler, dataloader_prep, train_val_ResNet_expert_cv, test_ResNet_expert, train_val_figure_plot_function
...
for k, index_train_val_test_data in enumerate(k_fold_index_train_val_test_data):
    ...
    # Training data
    train_x_color_mat_np, train_x_nt_localized_info_mat_np, train_y_np = data_prep_RNA_mat_3d_nt_localized_info_mat_PDB_data(Original_RNA_Data = train_data_utilized, padding_length=410.0)
    ...
    # Validation data
    val_x_color_mat_np, val_x_nt_localized_info_mat_np, val_y_np = data_prep_RNA_mat_3d_nt_localized_info_mat_PDB_data(Original_RNA_Data = val_data_utilized, padding_length=410.0)
    ...
    model_name_utilized = 'RNA_3d_mat_Fold_'+str(fold_num)+'_NUMO_ResNet_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
    ...
    train_val_record_obtained, saved_models_metrics_obtained = train_val_ResNet_expert_cv(device = device_utilized, 
    ...
    train_val_record_file_name = 'RNA_3d_mat_Fold_'+str(fold_num)+'_NUMOResNet_train_val_record_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
        '_weightd_'+str(weight_decay_value_utilized)+'_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+\
    ...
    saved_models_metrics_file_name = 'RNA_3d_mat_Fold_'+str(fold_num)+'_NUMOResNet_saved_models_metrics_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
        '_weightd_'+str(weight_decay_value_utilized)+'_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+\
            str(gamma_value_utilized)+'PDB_data.csv'
...
best_val_acc_model_k_fold_cv_file_name = 'RNA_3d_mat_best_val_acc_model_k_fold_cv_batch_NUMOResNet_'+str(batch_size_value_utilized)+\
...
best_val_loss_model_k_fold_cv_file_name = 'RNA_3d_mat_best_val_loss_model_k_fold_cv_batch_NUMOResNet_'+str(batch_size_value_utilized)+\
      '_lr_'+str(learning_rate_value_utilized)+'_weightd_'+str(weight_decay_value_utilized)+\
            '_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+str(gamma_value_utilized)+'PDB_data.csv'
...
model_from_last_epoch_k_fold_cv_file_name = 'RNA_3d_mat_model_from_last_epoch_k_fold_cv_batch_NUMOResNet_'+str(batch_size_value_utilized)+\
      '_lr_'+str(learning_rate_value_utilized)+'_weightd_'+str(weight_decay_value_utilized)+\
            '_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+str(gamma_value_utilized)+'PDB_data.csv'
